        ...
        <article class="prose enhanced-prose">
            ...
            <div id="projects" class="not-prose flex flex-col">
                <div class="projects-grid">
                    ...
                    <a class="flex flex-col justify-between p-6 rounded-lg transition-all bg-surface hover:bg-surface-hover shadow-md shadow-surface/20" href="https://github.com/catppuccin/youtube" target="_blank">
                        <div class="flex flex-col gap-y-2">
                    ...
                    <a class="flex flex-col justify-between p-6 rounded-lg transition-all bg-surface hover:bg-surface-hover shadow-md shadow-surface/20" href="https://github.com/catppuccin/freshrss" target="_blank">
                        <div class="flex flex-col gap-y-2">
