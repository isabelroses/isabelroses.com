    ...
    <main class="flex flex-col w-full max-w-[80ch] mx-auto">
        <article class="prose enhanced-prose">
            ...
            <ul>
                ...
                <li><a href="https://chrome.google.com/webstore/detail/sponsorblock-for-youtube/mnjggcdmjocbbbhaepdhchncahnbgone?hl=en" target="_blank">SponsorBlock</a> for skipping YouTube sponsors </li>
            </ul>
