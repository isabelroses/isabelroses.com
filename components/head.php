<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="../assets/avatar3.webp">
    <meta name="description" content="A collection of all my repos and my porfolio">
    <meta property="og:site_name" content="isabelroses.com">
    <meta property="og:title" content="Isabel's Website">
